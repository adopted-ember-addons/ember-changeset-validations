      ...
      setConfig: {
        'ember-changeset-validations': {
          messages: {
            ...
            tooLong:
              '[CUSTOM] {description} is too long (maximum is {max} characters)',
            tooShort:
              '[CUSTOM] {description} is too short (minimum is {min} characters)',
            between:
              '[CUSTOM] {description} must be between {min} and {max} characters',
            before: '[CUSTOM] {description} must be before {before}',
            onOrBefore:
              '[CUSTOM] {description} must be on or before {onOrBefore}',
            after: '[CUSTOM] {description} must be after {after}',
            onOrAfter: '[CUSTOM] {description} must be on or after {onOrAfter}',
            wrongDateFormat:
              '[CUSTOM] {description} must be in the format of {format}',
            wrongLength:
