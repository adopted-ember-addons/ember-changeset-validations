...
If you need to be able to override the entire validation message object,
you can use [`@embroider/macros`](https://www.npmjs.com/package/@embroider/macros) to set a POJO with the following keys:
